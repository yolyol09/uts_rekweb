...
class HelixUltimateFeatureMobile
{
	...
	public function renderFeature()
	{
		...
		$mobile_dropdown_toggle        = $mobile_animations === 'dropdown' ? 'animation: uk-animation-fade' : '';
		...
		if ($mobile_logo_pos == 'left' || $mobile_toggle == 'left') {
			...
			if ($mobile_toggle == 'left') {
				$output .= '<a class="uk-navbar-toggle uk-navbar-toggle-animate" href="#" uk-toggle="target: #tm-mobile;' . $mobile_dropdown_toggle . '">';
