...
<div class="profile-edit<?php echo $this->pageclass_sfx; ?>">
	...
	<form id="member-profile" action="<?php echo Route::_('index.php?option=com_users&task=profile.save'); ?>" method="post" class="form-validate uk-background-muted uk-padding" enctype="multipart/form-data">
